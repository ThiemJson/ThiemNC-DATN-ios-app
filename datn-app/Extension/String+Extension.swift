...
let keyCrypto: Array<UInt8> = Array("cse-slink-vcarvc".utf8)
let saltCrypto: Array<UInt8> = Array("bdvrty377pnvdas".utf8)
let arrIV: [UInt8] = Array("cse-slink-bdvrty".utf8)
...
extension String {
    var stringWidth: CGFloat {
        ...
        let boundingBox = self.trimmingCharacters(in: .whitespacesAndNewlines).boundingRect(with: constraintRect, options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: [NSAttributedString.Key.font: UIFont.getOpenSansSemiBoldFont(size: 16)], context: nil)
